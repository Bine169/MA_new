...
//	 * @throws Exception
//	 */
	private static void allocateOuterPolygons(int numberlocations, int numberpolygons, double[] criteria) throws Exception{
...
//		//alocate Polygons to locations
		...
		allocateOuterPolygons(numberlocations, numberpolygons, criteria);
